...
// const TotalOne=document.querySelector('#Totalall')

// main cart have all info
let cart=[]
...
class UI{
    ...
    setCartValues(cart){
        ...
        const ct = document.querySelector("#cart-total-overlay")
        console.log(ct)
        if(ct){
            ct.innerHTML = cartTotal.innerText;
        }
        // TotalOne=cartTotal.innerText;
